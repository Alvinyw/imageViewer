...
ThumbnailControl.prototype.SetCurrentIndex = function (index) {
	var _this = this;
...
ThumbnailControl.prototype.GetCurrentIndex = function () {
	var _this = this;
	return _this.cIndex;
};
// 清空图片，显示Loading...
...
ThumbnailControl.prototype.__getImageByUrl = function () {
	...
	newImage.className = 'aryThumbnailImages-item';
